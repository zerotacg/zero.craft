...
var debug_level = 10;
var image_base = "./textures/";
var part_class = "ico_blade";
var craft_slots_used  = new Array();
var craft =
{
    "color" : 0
  , "purity" : 0
...
function slotAddRemove(slot)
{
  ...
  {
    craft_slots_used[slot]    = new Array();
...
function generateMaterialList(slot)
{
  ...
  var sorted_mats = new Array();
  var reverse_lookup = new Object();
  var sitem;
  var sort_string;
...
function loadItemInfo(sheet_id, slot)
{
  ...
  */
  ...
  {
    item_info["formuli"][index] = new Object();
...
function showItemStats(islot)
{
  ...
  //var wnd_item_info = $("ui:interface:item_info");
  //wnd_item_info.style.height = 212 + 23 * stat_count;
  //loggetFunctionName(arguments.callee.toString()) + " - end");
};
